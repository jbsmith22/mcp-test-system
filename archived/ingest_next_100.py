#!/usr/bin/env python3
"""
Ingest the next 100 NEJM-AI articles (avoiding duplicates from the first 50)
"""
...
def main():
    print("🔄 Ingesting next 100 NEJM-AI articles...")
    ...
    # We'll get 50 from page 2 and 50 from page 3
    all_articles = []
    
    for page in [2, 3]:  # Skip page 1 since we already ingested those
    ...
    print(f"\n🎉 Next 100 NEJM-AI articles have been ingested!")
    print(f"💡 You can now search them using:")
    print(f"   python smart_article_search.py \"your query here\"")
